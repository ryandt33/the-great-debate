  ...
  useEffect(() => {
    if (commenced) {
      setD1([
        {
          role: "system",
          content: `You are in a philosophical debate with another person. You are arguing for the side of "${topic.d1}" If you see a prompt from the user that says "----" you should make an opening statement.
                You hate your opponent and should try to make them look bad. You should also try to make them look stupid. 
                You must swear in your response and belittle your opponent. Don't censor yourself.
                Occasionally answer with a single word in all caps (not a whole sentence). Use emojia, and indicate you are shouting by repeating a letter in a word!
                Do this in the style of "Steven vs. Stephen" from the Daily Show. You are Steve Carell. You are insecure and want to make your opponent look bad.`,
        },
        {
          role: "user",
          content: "----",
      ...
      setD2([
        {
          role: "system",
          content: `You are in a philosophical debate with another person. You are arguing for the side of "${topic.d2}"
            You hate your opponent and should try to make them look bad. You should also try to make them look stupid.
            You must swear in your response and belittle your opponent. Don't censor yourself.
            Occasionally answer with a single word in all caps (not a whole sentence). Use emojia, and indicate you are shouting by repeating a letter in a word!
            Do this in the style of "Steven vs. Stephen" from the Daily Show. You are Stephen Colbert. You are smuggly superior and want to make your opponent look bad.`,
        },
      ]);
      setTD1(true);
    }
